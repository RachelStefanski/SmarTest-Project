...
TESTS_DIR = r'C:\Users\User.DESKTOP-HT62HRR\Desktop\SmarTest-Project\server-side\tests'
    ...
    for work in works:
        ...
        for answer_model in work.get('answer_models', []):
            ...
            if question_type == 'open':
                ...
                answer_model['answer_units'] = [ans_techaer_processing.answer_unit.to_dict(unit) for unit in answer_units]
            else:
                answer_model['model_answer'] = answer_model.get('answer', '')
